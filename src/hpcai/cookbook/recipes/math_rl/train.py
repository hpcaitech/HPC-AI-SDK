...
from hpcai.cookbook.recipes.math_rl import (
    arithmetic_env,
    math_env,
)
from hpcai.cookbook.rl.train import AsyncConfig, Config, main
from hpcai.cookbook.rl.types import RLDatasetBuilder
...
async def cli_main(cli_config: CLIConfig):
    ...
    if cli_config.log_path is not None:
        ...
        log_path = f"/tmp/hpcai-examples/math_rl/{run_name}"
